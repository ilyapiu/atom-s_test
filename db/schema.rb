...
ActiveRecord::Schema[7.0].define(version: 2022_07_15_152308) do
  ...
  create_table "worker_services", force: :cascade do |t|
    ...
    t.index ["worker_id"], name: "index_worker_services_on_worker_id"
  end
  ...
  add_foreign_key "worker_services", "workers"
end
